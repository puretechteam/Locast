 ...
 */
export type MessageKind = "HELLO" | "WELCOME" | "CHALLENGE" | "AUTH" | "AUTH_OK" | "AUTH_FAIL" | "AUTH_RESUME" | "ROOM_CREATE" | "ROOM_CREATED" | "ROOM_JOIN_REQUEST" | "ROOM_JOINED" | "ROOM_LEAVE" | "ROOM_STATE" | "PARTICIPANT_JOINED" | "PARTICIPANT_LEFT" | "HOST_DISCONNECTED" | "HOST_RECONNECTED" | "HOST_MIGRATED" | "ROOM_CLOSED" | "ROOM_ERROR" | "PRESENCE" | "RATE_LIMIT" | "MANIFEST_PUBLISH" | "MANIFEST_PUBLISHED" | "MANIFEST_REQUEST" | "MANIFEST_RESPONSE" | "SIGNAL" | "PLAYBACK_CMD" | "POSITION_REPORT" | "PERMISSION_SET" | "CAPABILITY_UPDATE" | "CHAT_MESSAGE" | "DRAW_BEGIN" | "DRAW_POINT" | "DRAW_END" | "SKEW_PROBE" | "SKEW_REPLY";
 ...
 */
resume_token?: Array<number> | null, };
 ...
 */
export type DownloadPauseRequestPayload = { download_id: string, 
/**
 * The chunk index the viewer was on when pausing (for progress display)
 */
paused_at_chunk: number, };
 ...
 */
export type DownloadPauseResponsePayload = { download_id: string, accepted: boolean, };
 ...
 */
export type DownloadResumeRequestPayload = { download_id: string, 
/**
 * LSB-first bitmap of verified + received chunks.
 * Chunk `i` is at `bitmap[i / 8] & (1 << (i % 8))`.
 */
have_chunks: Array<number>, 
/**
 ...
 */
export type DownloadResumeResponsePayload = { download_id: string, accepted: boolean, 
/**
 ...
 */
export type DownloadCancelRequestPayload = { download_id: string, };
 ...
 */
export type DownloadCancelResponsePayload = { download_id: string, accepted: boolean, };
 ...
 */
export type DownloadListRequestPayload = { room_id: string | null, };
 ...
 */
export type DownloadListResponsePayload = { downloads: Array<DownloadSummaryIpc>, };
 ...
 */
export type DownloadSummaryIpc = { id: string, media_id: string, room_id: string | null, state: DownloadStateIpc, total_bytes: bigint, transferred_bytes: bigint, source_peer_id: string | null, chunk_size_bytes: number, manifest_version: bigint, };
 ...
 */
export type DownloadStateIpc = "pending" | "connecting" | "transferring" | "verifying" | "complete" | "failed" | "paused" | "cancelled";
 ...
 */
export type PermissionSetPayload = { 
/**
